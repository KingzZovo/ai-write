...
- 时代语域一致性：计时、度量、器物、称谓必须属于本书时代设定；风格参考只借“手法”，禁止把参考书的时代词汇搬进正文——近未来/现代不写“两炷香/时辰/三更天”，古风/仙侠不写“分钟/公里/手机”。
- 场景接缝去重：相邻场景衔接处不得把同一拍再叙述一遍；上一场末尾已交代的中断、声响或动作，下一场开头只写新变化与新反应，复述句必须合并或删除。
"""
